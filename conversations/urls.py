...
urlpatterns = [
    ...
    path('<int:pk>/turn/<int:turn_id>/delete/', views.turn_delete, name='turn_delete'),
    path('<int:pk>/turn/<int:turn_id>/weight/', views.turn_toggle_weight, name='turn_toggle_weight'),
    path('<int:pk>/turn/<int:after_turn_id>/insert/', views.turn_insert, name='turn_insert'),
    ...
    path('<int:pk>/tool/<int:tc_id>/delete/', views.tool_call_delete, name='tool_call_delete'),
    path('<int:pk>/tags/', views.conversation_tag_manage, name='conversation_tags'),
